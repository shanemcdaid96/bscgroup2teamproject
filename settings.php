...
<body>
  ...
  <!-- nav -->
    ...
    <section id="content" >
      ...
      <a href="changePic.php" style="font-size: 17px;" >Change Profile Picture</a></br>
      <a href="changeBg.php" style="font-size: 17px;">Change Background</a></br>
      <a href="changePw.php" style="font-size: 17px;">Change Password</a>
    </div>
