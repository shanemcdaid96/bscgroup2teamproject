...
$result = mysqli_query($connection, "SELECT * FROM emails Where ReceiverID=".$id." AND Approve='Yes'");
    ...
    //   print('<img src="uploads/'.$rowAttachmentID['Filename'].'"width=60 height=60>');      print('</a>');
    //   print('</td>');
